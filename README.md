...
<p align="center">
  ...
  <i>Building real-time, scalable web apps — one commit at a time.</i>
</p>
...
- Supports concurrent multi-user edits with data consistency and low-latency updates
- Gracefully handles disconnects and conflict resolution scenarios
...
- Designed a keyword-based scoring engine to evaluate resumes against job descriptions
- Generates actionable suggestions to improve ATS compatibility and surface missing skills
...
|---|---|
| **Languages** | Java (Core), JavaScript, SQL |
...
<p align="center">
  ...
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=AbhiTyagi17&layout=compact&theme=tokyonight&hide_border=true" height="160"/>
</p>
